...
def train_model(torch_config):
    data_dir = torch_config["data_dir"] if "data_dir" in torch_config else 'data/processed_data'
    batch_size = torch_config["batch_size"] if "batch_size" in torch_config else 4
    num_epochs = torch_config["num_epochs"] if "num_epochs" in torch_config else 100
